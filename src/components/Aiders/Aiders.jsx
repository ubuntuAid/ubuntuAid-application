              ...
              <div key={item.id} className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                <div className="border border-gray-300 rounded-xl p-5">
                  <div className="flex gap-5 mb-5">
                    <div>
                      <img src={`http://localhost:1337${item.attributes.AiderImage.data.attributes.url}`} alt="" width={150} />
                    </div>
                    <div>
                        ...
                        <div className="flex gap-2">
                         <div>
                          ...
                          <p className="text-[#0A72BA]">
                                  {item.attributes.reviewCount}{''} <span>{item.attributes.reviewCount === 1 ? 'review' : 'reviews'}</span>
                                  </p>
                        </div>
                      </div>
                      ...
                      <h3 className="font-bold uppercase text-[#6AA84F]">Location</h3>
