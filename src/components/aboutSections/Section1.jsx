  ...
  return (
    <>
       <section className="h-[100dvh] flex w-full">
            <div className="bg-[#0A72BA] h-[100%] md:w-[50%] flex flex-col justify-center items-center">
                <h1 className="md:text-7xl text-left font-bold text-white w-[50%]">Why <br/>UbuntuAid?</h1>
