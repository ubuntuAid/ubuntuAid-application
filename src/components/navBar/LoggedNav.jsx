              ...
              {isOpen && username && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg py-2">
                  <p className="px-4 py-2 text-gray-700 hover:bg-green-100 flex justify-between items-center">
                    <span>Account Settings</span> <span><i className="bx bx-chevron-right"></i></span>
                  </p>
                  <p className="px-4 py-2 text-gray-700 hover:bg-green-100 flex justify-between items-center">
                    <span>You have 0 new Notifications</span> <span><i className="bx bx-chevron-right"></i></span>
                  </p>
                  <p className="px-4 py-2 text-gray-700 hover:bg-green-100 flex justify-between items-center">
                    <span>Just for you</span> <span><i className="bx bx-chevron-right"></i></span>
                  </p>
                  <p className="px-4 py-2 text-gray-700 hover:bg-green-100 flex justify-between items-center">
                    <span>Saved</span> <span><i className="bx bx-chevron-right"></i></span>
                  </p>
                  <p className="px-4 py-2 text-gray-700 hover:bg-green-100 flex justify-between items-center">
                    <span>Asked Questions</span> <span><i className="bx bx-chevron-right"></i></span>
                  </p>
                  <p className="px-4 py-2 text-gray-700 hover:bg-green-100 flex justify-between items-center">
                    <span>Reviews</span> <span><i className="bx bx-chevron-right"></i></span>
                  </p>
                  <button
                    onClick={handleSignOut}
                    className="w-full text-left px-4 py-2 text-white bg-[#6AA84F] border-none flex justify-between items-center"
                  >
                    <span>Sign Out</span><i className="bx bx-log-out"></i>
                  </button>
                </div>
              )}
            </div>
